  ...
  return (
    <section className="relative min-h-[90vh] pb-20 flex flex-col items-center justify-center px-4 text-center">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 30%, rgba(169, 112, 255, 0.1) 0%, transparent 50%)",
        }}
      />
      ...
      <h1
        ...
        style={{
          background:
            "linear-gradient(135deg, #ffffff 0%, #a970ff 50%, #bb88ff 100%)",
      ...
      <p className="text-sm md:text-base text-white/50 mb-8 max-w-2xl mx-auto">
        Every light represents a personal goal. Join the movement and illuminate
        your ambition on Cleveland's digital skyline.
      </p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
        <Button
          ...
          style={{
            ...
            boxShadow:
              "0 0 30px rgba(169, 112, 255, 0.4), 0 0 60px rgba(169, 112, 255, 0.2)",
          }}
        >
          Add Your Light
